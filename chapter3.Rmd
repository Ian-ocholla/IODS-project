...
From the model, the p-vales for the four variables are statistically significant.
The output supports the hypothesis that gender, study time, going out and quality family relationship affects the student's alcohol consumption. 
...
```
From the, 230 low alcohol consumption was corrected while 29 were incorrectly predicted. on the other hand, 52 observation of high alcohol consumption were correctly predicted while 59 were wrongly predicted.
